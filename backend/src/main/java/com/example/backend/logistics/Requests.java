...
public final class Requests {
  ...
  public record Product(
      ...
      @NotNull @DecimalMin("0.001") BigDecimal weightKg,
      @NotNull @DecimalMin("0") BigDecimal price) {}

  public record Warehouse(
      @NotBlank @Size(max = 120) String name,
      @NotBlank @Size(max = 500) String address,
      @com.fasterxml.jackson.annotation.JsonProperty(required = true) @Min(-90) @Max(90)
          double latitude,
      @com.fasterxml.jackson.annotation.JsonProperty(required = true) @Min(-180) @Max(180)
          double longitude,
      @Min(1) int capacity,
  ...
  public record Stock(
      @NotNull UUID warehouseId, @NotNull UUID productId, @Min(1) @Max(1000000) int quantity) {}
  ...
  public record DriverAvailability(@NotNull DriverStatus status) {}

  public record VehicleAvailability(@NotNull VehicleStatus status) {}
